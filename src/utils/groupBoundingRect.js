export default function groupBoundingRect(boundingRects) {
  return boundingRects.reduce((groupedBoundingRect, boundingRect) => {
    if (
      typeof groupedBoundingRect.top === 'undefined' ||
    ...
    if (
      typeof groupedBoundingRect.right === 'undefined' ||
    ...
    if (
      typeof groupedBoundingRect.bottom === 'undefined' ||
    ...
    if (
      typeof groupedBoundingRect.left === 'undefined' ||
